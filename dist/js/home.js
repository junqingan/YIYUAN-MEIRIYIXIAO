...
var homeController = __webpack_require__(3).getInstance();
homeController.init();
...
const joke = __webpack_require__(4);
const imgjoke = __webpack_require__(5);
const weather = __webpack_require__(6);
const history = __webpack_require__(7);
    ...
    $.ajax({
        ...
        success: function (res, item) {
            ...
            $.each(data, function (idx, item) {
                html += '<div class="gifList" >' + '<img src=' + item.img + '>' + '</div>';
                $('.gif_joke').html(html);
            });
        }
    });
...
function start() {
    ...
    $.ajax({
        ...
        success: function (res, item) {
            ...
            $.each(data, function (idx, item) {
                // console.log(item);
                html += '<div class="imglist">' + '   <img src=' + item.img + '>' + '</div>';
                $('.img_joke').html(html);
            });
        }
    });
...
function start() {
    ...
    $.ajax({
        ...
        success: function (res, item) {
            ...
            var htmlnow = '',
                htmlList = '';
            htmlnow += '    <li class="now">' + '        <span class="cityinfo">' + City.c7 + '</span>' + '        <div class="con">' + '            <img src=' + Now.weather_pic + ' alt="">' + '               <h3><em>' + Now.temperature + '</em> °</h3>' + '               <p >空气湿度：<code class="press">' + Now.sd + '</code></p>' + '               <p >风向：<em class="press">' + Now.wind_direction + '</em></p>' + '        </div>' + '    </li>';
            $.each(arr, function (index, item) {
                htmlList += '    <li class="list">' + '        <div class="con">' + '            <div class="img">' + '               <img src=' + item.day_weather_pic + ' alt="">' + '               <p>' + item.day_weather + '<em>' + item.day_air_temperature + '℃' + '</em> </p>' + '            </div>' + '            <div class="txt">' + '            <p >紫外线强度：<code class="press">' + item.ziwaixian + '</code></p>' + '            <p >风向：<em class="press">' + item.day_wind_direction + '</em></p>' + '               <p >降水概率：<em class="press">' + item.jiangshui + '</em></p>' + '            </div>' + '        </div>' + '    </li>';
...
function start() {
    ...
    function renderData(res) {
        ...
        $.each(List, function (index, item) {
            html += '<div class="list">' + '   <img src=' + item.img + '>' + '   <p class="tit">' + '       <span>' + item.title + '</span>' + '   </p>' + '</div>';
